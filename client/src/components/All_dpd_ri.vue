        ...
        <div :class="{'d-flex': deviceWidth > 1200, '' : deviceWidth < 1200 }">
            ...
            <div class="flex-grow-1">
                <div class="row row-cols-2 row-cols-lg-4 row-cols-md-3 g-2 g-md-3 g-lg-3 mt-3">
                    <div class="col" id="my-table" v-for="calon in filteredCalons.slice((currentPage-1)*perPage,(currentPage-1)*perPage+perPage)" :key="calon.id_calon" :per-page="perPage" :current-page="currentPage">
