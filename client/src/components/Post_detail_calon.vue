    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 right-col">
                <div class="row">
                <!-- poster dan slogan -->
                    <div class="card text-white poster-calon mb-2">
                        <img src="../assets/images/poster.jpg" class="poster-calon" alt="dpr 2">
                        <div class="card-img-overlay d-flex align-items-end p-0 poster-calon">
                            <p class="card-text poster-caption d-flex align-items-center justify-content-center p-3">“Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...”</p>
                        </div>
                    </div>
                    <div class="p-4">
                        <!-- posts just text-->
